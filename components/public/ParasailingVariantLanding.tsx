...
export default function ParasailingVariantLanding({
  locale,
  variant,
  tour,
  transferHotels
}: ParasailingVariantLandingProps) {
  ...
  const inclusions = PARASAILING_BASE_TOUR.inclusions[locale] ?? PARASAILING_BASE_TOUR.inclusions.es;
  const highlights = PARASAILING_BASE_TOUR.highlights[locale] ?? PARASAILING_BASE_TOUR.highlights.es;
            ...
            <div className="flex items-end gap-8">
              ...
              <div>
                ...
                <p className="text-xs uppercase tracking-[0.3em] text-slate-500">
                  {t("tour.hero.reviewsCount", { count: 980 })}
                </p>
              </div>
            </div>
