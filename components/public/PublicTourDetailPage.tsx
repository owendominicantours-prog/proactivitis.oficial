...
import {
  ...
  getApprovedTourReviewsForTour,
  getTourReviewSummaryForTour,
} from "@/lib/tourReviews";
import {
  parseAdminItinerary,
  parseItinerary,
  ItineraryStop,
...
import {
  normalizeTourLocation,
  normalizeTourLanguages,
...
const LEGACY_TOUR_SLUG_REDIRECTS: Record<string, string> = {
  ...
  "saona-island-full-day-tour":
    "/tours/tour-y-entrada-para-de-isla-saona-desde-punta-cana",
  "atv-horseback-parasailing-combo":
    "/tours/excursion-en-buggy-y-atv-en-punta-cana",
  "sunset-sup-cocktails": "/tours/sunset-catamaran-snorkel",
  "zip-line-adventure-punta-cana": "/tours",
  "party-boat-punta-cana":
    "/thingtodo/tours/party-boat-punta-cana-guia-completa",
...
const toLocalizedPath = (path: string, locale: Locale) =>
...
const TOUR_KEYWORDS_BY_SLUG: Record<
  string,
...
const TOUR_SCHEMA_ALTERNATE_NAMES_BY_SLUG: Record<
  string,
  Partial<Record<Locale, string[]>>
> = {
  "tour-en-buggy-por-punta-cana": {
...
const TOUR_FAQ_OVERRIDES: Record<
  string,
  Partial<Record<Locale, TourFaqItem[]>>
> = {
  "tour-en-buggy-en-punta-cana": {
    es: [
      {
        ...
        answer:
          "Incluye buggy, guía local, ruta off-road y paradas para foto. Antes de pagar ves el total final, sin cargos sorpresa.",
      },
      {
        question: "Hay parada en cueva o cenote?",
        answer:
          "Sí. Normalmente hacemos parada en cueva o cenote y en casa típica para probar café y cacao dominicano.",
      },
      {
        question: "Necesito licencia para conducir?",
        answer:
          "Sí, necesitas licencia vigente y ser mayor de edad para conducir. Antes de salir damos briefing de seguridad obligatorio.",
      },
    ],
    en: [
      {
        ...
        answer:
          "It includes buggy, local guide, off-road route and photo stops. You see the full final price before payment.",
      },
      {
        question: "Is there a cave or cenote stop?",
        answer:
          "Yes. Most routes include a cave or cenote stop plus a local house visit for Dominican coffee and cacao tasting.",
      },
      {
        question: "Do I need a drivers license?",
        answer:
          "Yes, a valid drivers license and adult age are required to drive. A mandatory safety briefing happens before departure.",
      },
    ],
    fr: [
      {
        ...
        answer:
          "Le tour comprend buggy, guide local, piste off-road et arrets photo. Le prix final est affiche avant paiement.",
      },
      {
        question: "Y a-t-il un arret grotte ou cenote?",
        answer:
          "Oui. La plupart des parcours incluent un arret grotte ou cenote et une maison locale avec degustation cafe-cacao.",
      },
      {
        question: "Faut-il un permis de conduire?",
        answer:
          "Oui, permis valide et majorite sont requis pour conduire. Le briefing securite est obligatoire avant de partir.",
      },
    ],
  },
  "excursion-en-buggy-y-atv-en-punta-cana": {
    es: [
      {
        ...
        answer:
          "Sí. Puedes elegir buggy o ATV al reservar, y te confirmamos disponibilidad real para ese horario.",
      },
      {
        question: "¿Cuánto dura la excursión?",
        answer:
          "La actividad dura aproximadamente {durationLabel}, incluyendo las paradas.",
      },
      {
        question: "¿Hay recogida en hotel?",
        answer:
          "Sí, la mayoria de salidas incluye pickup en hoteles de Punta Cana y Bavaro con punto y hora confirmados.",
      },
    ],
    en: [
      {
        ...
        answer:
          "Yes. You choose buggy or ATV during booking and we confirm real availability for your selected time.",
      },
      {
      ...
      },
      {
        ...
        answer:
          "Yes, most departures include hotel pickup in Punta Cana/Bavaro with a confirmed time and meeting point.",
      },
    ],
    fr: [
      {
        ...
        answer:
          "Oui. Vous choisissez buggy ou ATV pendant la reservation, puis nous confirmons la disponibilite reelle.",
      },
      {
      ...
      },
      {
        ...
        answer:
          "Oui, la plupart des departs incluent la prise en charge hotel a Punta Cana/Bavaro avec horaire confirme.",
      },
    ],
  },
  "transfer-privado-proactivitis": {
    es: [
      {
        ...
        answer:
          "Es privado para tu grupo, con chofer verificado y vehiculo exclusivo.",
      },
      {
        question: "Incluye seguimiento de vuelo?",
        answer:
          "Sí, monitoreamos la hora de llegada y ajustamos la espera cuando es necesario.",
      },
      {
        question: "Puedo reservar ida y vuelta?",
        answer:
          "Sí, elige la opción round trip en el checkout para asegurar ambos trayectos.",
      },
    ],
    en: [
      {
        ...
        answer:
          "It is private for your group with a verified driver and dedicated vehicle.",
      },
      {
    ...
    fr: [
      {
        ...
        answer:
          "C est un transfert prive pour votre groupe avec chauffeur verifie.",
      },
      {
        question: "Suivez-vous les vols?",
        answer:
          "Oui, nous suivons l heure d arrivee et ajustons l attente si besoin.",
      },
      {
        question: "Puis-je reserver aller-retour?",
        answer:
          "Oui, choisissez aller-retour au checkout pour les deux trajets.",
      },
    ],
  },
  "tour-isla-saona-desde-bayhibe-la-romana": {
    es: [
      {
        ...
        answer:
          "Sale desde Bayahibe o La Romana. Según la salida, combinas lancha rápida y catamarán durante el día.",
      },
      {
        question: "Incluye almuerzo y bebidas?",
        answer:
          "Sí, incluye almuerzo tipo buffet y bebidas basicas. Los detalles exactos aparecen antes de confirmar reserva.",
      },
      {
    ...
    en: [
      {
        ...
        answer:
          "Departure is from Bayahibe or La Romana. Depending on the schedule, the route combines speedboat and catamaran.",
      },
      {
        question: "Is lunch and drinks included?",
        answer:
          "Yes, buffet lunch and basic drinks are included. Final inclusions are shown clearly before checkout.",
      },
      {
    ...
    fr: [
      {
        ...
        answer:
          "Depart depuis Bayahibe ou La Romana. Selon l horaire, le parcours combine bateau rapide et catamaran.",
      },
      {
        question: "Dejeuner et boissons inclus?",
        answer:
          "Oui, dejeuner buffet et boissons de base inclus. Le detail final des inclusions apparait avant paiement.",
      },
      {
    ...
    es: [
      {
        ...
        answer:
          "Incluye transporte ida y vuelta, parada en Cascada El Limon, tiempo de playa en Cayo Levantado y almuerzo.",
      },
      {
        question: "Cuánto dura el viaje desde Punta Cana?",
        answer:
          "Es un tour de día completo con salida temprano y regreso en la tarde.",
      },
      {
    ...
    en: [
      {
        ...
        answer:
          "Round-trip transport, El Limon Waterfall stop, beach time in Cayo Levantado and lunch are included.",
      },
      {
        question: "How long is the trip from Punta Cana?",
        answer:
          "It is a full-day tour with early departure and afternoon return.",
      },
      {
    ...
    fr: [
      {
        ...
        answer:
          "Transfert aller-retour, arret a la cascade El Limon, temps de plage a Cayo Levantado et dejeuner inclus.",
      },
      {
        question: "Combien de temps dure le trajet depuis Punta Cana?",
        answer:
          "C est une excursion a la journee avec depart tot et retour l apres-midi.",
      },
      {
    ...
    es: [
      {
        ...
        answer:
          "Sí. Es una salida en catamarán con música, open bar y parada para snorkel en zona segura.",
      },
      {
        question: "¿Hay recogida en hotel?",
      ...
      },
      {
        question: "¿Qué llevar?",
        answer:
          "Lleva traje de baño, toalla, protector solar y ropa ligera. Si quieres extras o fotos, lleva efectivo opciónal.",
      },
    ],
    en: [
      {
        ...
        answer:
          "Yes. It is a catamaran trip with music, open bar and a dedicated snorkel stop in a safe area.",
      },
      {
        question: "Is hotel pickup included?",
      ...
      },
      {
        ...
        answer:
          "Bring swimsuit, towel, sunscreen and light clothes. Optional cash is useful for extras and photos.",
      },
    ],
    fr: [
      {
        ...
        answer:
          "Oui. Sortie catamaran avec musique, open bar et arret snorkel dans une zone adaptee.",
      },
      {
        question: "La prise en charge hotel est incluse?",
        answer:
          "La prise en charge a Punta Cana/Bavaro est confirmee apres reservation.",
      },
      {
        question: "Que faut-il apporter?",
        answer:
          "Prenez maillot, serviette, creme solaire et vetements legers. Cash optionnel pour extras et photos.",
      },
    ],
  },
  "avistamiento-de-ballenas-samana-cayo-levantado-y-cascadas-desde-punta-cana":
      ...
      es: [
        {
          ...
          answer:
            "La mejor ventana suele ser de enero a marzo, cuando Samana recibe la mayor presencia de ballenas jorobadas.",
        },
        {
        ...
        },
        {
          ...
          answer:
            "Sí, es jornada completa. Se sale temprano desde Punta Cana y se regresa en la tarde-noche.",
        },
      ],
      en: [
        {
          ...
          answer:
            "Peak season is usually January to March, when humpback whale activity in Samana is strongest.",
        },
        {
        ...
        },
        {
          ...
          answer:
            "Yes, it is a full-day experience with early departure from Punta Cana and return later in the day.",
        },
      ],
      fr: [
        {
          ...
          answer:
            "La haute saison est en general de janvier a mars, quand l activite des baleines est la plus forte a Samana.",
        },
        {
        ...
        },
        {
          ...
          answer:
            "Oui, excursion a la journee complete avec depart matinal depuis Punta Cana et retour en fin de journee.",
        },
      ],
    },
  "parasailing-punta-cana": {
    es: [
      {
        ...
        answer:
          "El vuelo suele durar entre 10 y 12 minutos en el aire, mas el tiempo de navegacion y preparacion.",
      },
      {
        question: "Es seguro?",
      ...
      },
      {
        ...
        answer:
          "Sí, se puede volar en pareja o trío según peso combinado y condiciones del viento.",
      },
    ],
    en: [
      {
        ...
        answer:
          "The parasailing flight is usually 10-12 minutes in the air, plus setup and boat navigation time.",
      },
      {
        question: "Is it safe?",
      ...
      },
      {
        ...
        answer:
          "Yes, double and sometimes triple flights are possible depending on total weight and wind conditions.",
      },
    ],
    fr: [
      {
        ...
        answer:
          "Le vol dure en general 10 a 12 minutes, plus le temps de preparation et de navigation en bateau.",
      },
      {
      ...
      },
      {
        ...
        answer:
          "Oui, vol double et parfois triple selon le poids combine et les conditions meteo.",
      },
    ],
  },
  "tour-y-entrada-para-de-isla-saona-desde-punta-cana": {
    es: [
      {
        ...
        answer:
          "Sí, incluye entradas, transporte y tiempo real en playa. Veras el detalle final antes de confirmar.",
      },
      {
      ...
      },
      {
        ...
        answer:
          "Sí, coordinamos recogida en hoteles de Punta Cana y Bavaro con horario confirmado despues de reservar.",
      },
    ],
    en: [
      {
        ...
        answer:
          "Yes, entry tickets, transport and real beach time are included. Final details are shown before checkout.",
      },
      {
      ...
      },
      {
        question: "Is hotel pickup included?",
        answer:
          "Yes, we coordinate hotel pickup in Punta Cana/Bavaro and confirm your exact time after booking.",
      },
    ],
    fr: [
      {
        ...
        answer:
          "Oui, billets, transport et vrai temps de plage inclus. Le detail final apparait avant validation.",
      },
      {
      ...
      },
      {
        question: "La prise en charge hotel est incluse?",
        answer:
          "Oui, nous confirmons la prise en charge hotel a Punta Cana/Bavaro apres la reservation.",
      },
    ],
  },
  "tour-de-safari-cultural-por-el-pais-de-republica-dominicana-desde-punta-cana":
      ...
      es: [
        {
          ...
          answer:
            "Visitamos zonas rurales, pueblos locales, casa típica y paradas para degustaciones dominicanas.",
        },
        {
        ...
        },
        {
          ...
          answer:
            "Sí, es una experiencia tranquila y educativa, recomendada para familias y viajeros de ritmo relajado.",
        },
      ],
      en: [
        {
          ...
          answer:
            "The route includes countryside areas, local villages, a traditional home and Dominican tastings.",
        },
        {
        ...
        },
        {
          question: "Is it family friendly?",
          answer:
            "Yes, it is a relaxed and educational tour, great for families and travelers who prefer a calm pace.",
        },
      ],
      fr: [
        {
          ...
          answer:
            "Le parcours inclut campagne, villages locaux, maison traditionnelle et degustations dominicaines.",
        },
        {
        ...
        },
        {
          question: "C est adapte aux familles?",
          answer:
            "Oui, c est une excursion culturelle calme, ideale pour familles et voyageurs qui veulent un rythme doux.",
        },
      ],
    },
  "excursion-de-un-dia-a-santo-domingo-desde-punta-cana": {
    es: [
      {
        ...
        answer:
          "Incluye recorrido por Zona Colonial, paradas históricas y acompañamiento de guía local durante la visita.",
      },
      {
      ...
      },
      {
        ...
        answer:
          "Es día completo. La salida es temprano desde Punta Cana y el regreso es en la tarde.",
      },
    ],
    en: [
      {
        ...
        answer:
          "It includes a Colonial Zone tour, key historical stops and a local guide throughout the visit.",
      },
      {
      ...
      },
      {
        ...
        answer:
          "It is a full-day trip, with early departure from Punta Cana and return in the afternoon.",
      },
    ],
    fr: [
      {
        ...
        answer:
          "La visite comprend Zone Coloniale, arrets historiques principaux et accompagnement par un guide local.",
      },
      {
      ...
      },
      {
        ...
        answer:
          "C est une excursion a la journee complete, avec depart matinal depuis Punta Cana et retour l apres-midi.",
      },
    ],
  },
  "party-boat-sosua": {
    es: [
      {
        ...
        answer:
          "La salida compartida inicia en USD 65 por persona. Si viajas en grupo, también puedes elegir opción privada o VIP.",
      },
      {
        question: "El tour incluye open bar y snorkel?",
        answer:
          "Sí, incluye open bar, música a bordo, parada de snorkel y tiempo para disfrutar la bahía de Sosúa.",
      },
      {
        question: "Hay pickup desde Puerto Plata, Amber Cove o Taino Bay?",
        answer:
          "Sí. Coordinamos recogida en Puerto Plata, Amber Cove y Taino Bay según horario, tráfico y disponibilidad del día.",
      },
    ],
    en: [
      {
        ...
        answer:
          "Shared trips start at USD 65 per person. Private and VIP formats are available for groups who want a custom setup.",
      },
      {
        question: "Does it include open bar and snorkeling?",
        answer:
          "Yes, it includes open bar, onboard music, a snorkeling stop, and swim time in Sosua Bay.",
      },
      {
        question:
          "Is pickup available from Puerto Plata, Amber Cove, or Taino Bay?",
        answer:
          "Yes. We coordinate pickup from Puerto Plata, Amber Cove and Taino Bay based on schedule and same-day availability.",
      },
    ],
    fr: [
      {
        ...
        answer:
          "Le depart partage commence a USD 65 par personne. Des versions privees et VIP sont aussi disponibles pour les groupes.",
      },
      {
        question: "Le tour inclut-il open bar et snorkeling?",
        answer:
          "Oui, open bar, musique a bord, arret snorkeling et temps de baignade dans la baie de Sosua sont inclus.",
      },
      {
        question:
          "Pickup possible depuis Puerto Plata, Amber Cove ou Taino Bay?",
        answer:
          "Oui. Nous coordonnons la prise en charge depuis Puerto Plata, Amber Cove et Taino Bay selon horaire et disponibilite.",
      },
    ],
  },
  "scape-park-full-admission-punta-cana": {
    es: [
      {
        ...
        answer:
          "Incluye Hoyo Azul, zip lines, cuevas, Saltos Azules, Faunaland, transporte ida y vuelta y almuerzo buffet.",
      },
      {
        question: "¿Es una buena opción para familias?",
        answer:
          "Sí. Es la opción más equilibrada para familias y grupos porque combina naturaleza, agua y actividades de distinta intensidad en un mismo día.",
      },
      {
        question: "¿Cuánto dura la experiencia?",
        answer:
          "La duración estimada es {durationLabel}, contando parque, traslados y tiempo para almorzar.",
      },
    ],
    en: [
      {
        ...
        answer:
          "It includes Hoyo Azul, zip lines, caves, Blue Jumps, Faunaland, round-trip transport and buffet lunch.",
      },
      {
        question: "Is it a good option for families?",
        answer:
          "Yes. It is the most balanced choice for families and groups because it combines nature, water and different activity levels in one day.",
      },
      {
        question: "How long does the experience last?",
        answer:
          "Estimated duration is {durationLabel}, including park time, transfers and buffet lunch.",
      },
    ],
    fr: [
      {
        ...
        answer:
          "Hoyo Azul, tyroliennes, grottes, Saltos Azules, Faunaland, transport aller-retour et buffet sont inclus.",
      },
      {
        question: "Est-ce une bonne option pour les familles?",
        answer:
          "Oui. C est l option la plus equilibree pour les familles et groupes car elle combine nature, eau et activites de differente intensite.",
      },
      {
        question: "Quelle est la duree de l experience?",
        answer:
          "La duree estimee est de {durationLabel}, avec parc, transferts et temps pour dejeuner.",
      },
    ],
  },
  "scape-park-sunshine-cruise-punta-cana": {
    es: [
      {
        ...
        answer:
          "Agrega un catamarán al final del parque con snorkel, barra libre y parada en la piscina natural de Juanillo.",
      },
      {
        question: "Es mejor que Full Admission normal?",
        answer:
          "Si quieres selva y mar en el mismo día, esta es la mejora más completa. Si solo quieres parque, Full Admission suele ser suficiente.",
      },
      {
        question: "Incluye almuerzo y transporte?",
        answer:
          "Sí, incluye transporte ida y vuelta y almuerzo buffet, ademas del crucero Sunshine.",
      },
    ],
    en: [
      {
        ...
        answer:
          "It adds a catamaran after the park activities, with snorkel, open bar and a stop at Juanillo natural pool.",
      },
      {
        question: "Is it better than regular Full Admission?",
        answer:
          "If you want both jungle and sea in one day, this is the strongest upgrade. If you only want the park, Full Admission is usually enough.",
      },
      {
        question: "Does it include lunch and transport?",
        answer:
          "Yes. It includes round-trip transport, buffet lunch and the Sunshine cruise experience.",
      },
    ],
    fr: [
      {
        ...
        answer:
          "Un catamaran apres le parc avec snorkel, open bar et arret a la piscine naturelle de Juanillo.",
      },
      {
        question: "Est-ce mieux que le Full Admission classique?",
        answer:
          "Si vous voulez jungle et mer le meme jour, c est la meilleure evolution. Si vous voulez seulement le parc, Full Admission suffit souvent.",
      },
      {
        question: "Le dejeuner et le transport sont-ils inclus?",
        answer:
          "Oui. Le transport aller-retour, le buffet et le Sunshine cruise sont inclus.",
      },
    ],
  },
  "scape-park-buggies-punta-cana": {
    es: [
      {
        ...
        answer:
          "Incluye el acceso completo al parque mas una ruta en buggy 4x4 por senderos exclusivos dentro de Cap Cana.",
      },
      {
        question: "Para quien conviene este combo?",
        answer:
          "Es el mejor formato para viajeros que priorizan accion y quieren sumar conduccion off-road al parque.",
      },
      {
        question: "Hay equipo de seguridad incluido?",
        answer:
          "Sí, el equipo de seguridad esta incluido junto con transporte y almuerzo buffet.",
      },
    ],
    en: [
      {
        ...
        answer:
          "It includes full park access plus a 4x4 buggy route on exclusive Cap Cana trails.",
      },
      {
        question: "Who is this combo best for?",
        answer:
          "It is the best fit for travelers who want action first and want to add off-road driving to the park day.",
      },
      {
        question: "Is safety gear included?",
        answer:
          "Yes. Safety gear is included together with transport and buffet lunch.",
      },
    ],
    fr: [
      {
        ...
        answer:
          "L acces complet au parc plus un parcours buggy 4x4 sur des pistes exclusives de Cap Cana.",
      },
      {
        question: "Pour qui ce combo est-il ideal?",
        answer:
          "Pour les voyageurs qui veulent surtout de l action et ajouter la conduite off-road a la journee de parc.",
      },
      {
        question: "L equipement de securite est-il inclus?",
        answer:
          "Oui. L equipement de securite, le transport et le buffet sont inclus.",
      },
    ],
  },
  "juanillo-vip-scape-park-punta-cana": {
    es: [
      {
        ...
        answer:
          "Es la opción más exclusiva: Hoyo Azul con prioridad, catamarán premium, Juanillo Beach Club y almuerzo superior.",
      },
      {
        question: "¿Es una excursión de lujo real?",
        answer:
          "Sí. Esta pensada para viajeros que quieren menos densidad, mejor servicio y una experiencia mas premium en Cap Cana.",
      },
      {
        question: "Incluye snorkel y bebidas premium?",
        answer:
          "Sí, incluye navegación con bebidas premium y snorkel durante la salida en catamarán.",
      },
    ],
    en: [
      {
        ...
        answer:
          "It is the most exclusive option: priority Hoyo Azul access, premium catamaran, Juanillo Beach Club and elevated lunch.",
      },
      {
        question: "Is it a real luxury excursion?",
        answer:
          "Yes. It is designed for travelers who want less crowding, stronger service and a more premium Cap Cana day.",
      },
      {
        question: "Does it include snorkel and premium drinks?",
        answer:
          "Yes. The catamaran segment includes premium drinks and snorkel.",
      },
    ],
    fr: [
      {
        ...
        answer:
          "C est l option la plus exclusive : acces prioritaire a Hoyo Azul, catamaran premium, Juanillo Beach Club et dejeuner superieur.",
      },
      {
        question: "Est-ce une vraie excursion luxe?",
        answer:
          "Oui. Elle vise les voyageurs qui veulent moins de foule, un meilleur service et une journee plus premium a Cap Cana.",
      },
      {
        question: "Le snorkel et les boissons premium sont-ils inclus?",
        answer:
          "Oui. La partie catamaran comprend boissons premium et snorkel.",
      },
    ],
  },
  "scape-park-punta-cana": {
    es: [
      {
        ...
        answer:
          "Full Admission es la base más equilibrada. Sunshine Cruise agrega mar y catamarán, Buggies suma adrenalina off-road, y Juanillo VIP es la opción más exclusiva.",
      },
      {
        question: "Qué debo saber si estoy hospedado en Bayahibe o La Romana?",
        answer:
          "Para hoteles en Bayahibe o La Romana la recogida suele operar solo martes y sábados, y puede aplicar suplemento de transporte según hotel.",
      },
      {
        question:
          "A que hora termina el tour y como funcionan las actividades especiales?",
        answer:
          "La operación suele arrancar por la mañana y el regreso sale normalmente entre 03:30 PM y 04:30 PM, con llegada al hotel entre 05:00 PM y 06:00 PM. Los buggies se asignan por turnos al llegar, Sunshine Cruise suele operar al final del día y Juanillo VIP lleva un ritmo más relajado.",
      },
    ],
    en: [
      {
        ...
        answer:
          "Full Admission is the balanced base. Sunshine Cruise adds sea and catamaran, Buggies adds off-road adrenaline, and Juanillo VIP is the most exclusive option.",
      },
      {
        question: "What should I know if I stay in Bayahibe or La Romana?",
        answer:
          "For hotels in Bayahibe or La Romana, pickup usually runs only on Tuesdays and Saturdays, and an added transport supplement may apply depending on the hotel.",
      },
      {
        question:
          "What time does the day end and how do the special activities run?",
        answer:
          "Operations usually start in the morning and return transport often leaves between 3:30 PM and 4:30 PM, with hotel arrival between 5:00 PM and 6:00 PM. Buggies are assigned in time slots at the counter, Sunshine Cruise usually runs at the end of the day, and Juanillo VIP follows a more relaxed flow.",
      },
    ],
    fr: [
      {
        ...
        answer:
          "Full Admission est la base la plus equilibree. Sunshine Cruise ajoute mer et catamaran, Buggies apporte plus d adrenaline, et Juanillo VIP est l option la plus exclusive.",
      },
      {
        question: "Que faut-il savoir si je loge a Bayahibe ou La Romana?",
        answer:
          "Pour les hotels de Bayahibe ou La Romana, la prise en charge fonctionne generalement seulement mardi et samedi, et un supplement transport peut s appliquer selon l hotel.",
      },
      {
        question:
          "A quelle heure se termine la journee et comment fonctionnent les activites speciales?",
        answer:
          "L operation commence generalement le matin et le retour part souvent entre 15h30 et 16h30, avec arrivee hotel entre 17h00 et 18h00. Les buggies sont attribues par tour au comptoir, Sunshine Cruise se fait souvent en fin de journee et Juanillo VIP suit un rythme plus detendu.",
      },
    ],
  },
  "private-buggy-tour-cenote-swim-dominican-lunch": {
    es: [
      {
        ...
        answer:
          "Incluye buggy privado para tu grupo, guía, parada para baño en cenote o río, almuerzo dominicano, una bebida y fotos del recorrido.",
      },
      {
        question: "¿Es una excursión compartida o privada?",
        answer:
          "Es una experiencia privada. No se mezcla tu grupo con otros viajeros durante la salida.",
      },
      {
        question: "Que debo llevar para esta experiencia?",
        answer:
          "Recomendamos ropa cómoda, ropa de baño, toalla, protector solar y calzado que puedas usar en terreno off-road y zonas con agua.",
      },
    ],
    en: [
      {
        ...
        answer:
          "It includes a private buggy for your group, guide, cenote or river swim stop, Dominican lunch, one drink, and photos of the experience.",
      },
      {
        question: "Is this a shared or private excursion?",
        answer:
          "It is a private experience. Your group is not mixed with other travelers during the tour.",
      },
      {
        question: "What should I bring for this experience?",
        answer:
          "We recommend comfortable clothes, swimwear, towel, sunscreen, and shoes suitable for off-road terrain and water stops.",
      },
    ],
    fr: [
      {
        ...
        answer:
          "Le tour comprend buggy prive pour votre groupe, guide, arret baignade en cenote ou riviere, dejeuner dominicain, une boisson et photos de l experience.",
      },
      {
        question: "Est-ce une excursion partagee ou privee?",
        answer:
          "C est une experience privee. Votre groupe n est pas melange avec d autres voyageurs.",
      },
      {
        question: "Que faut-il apporter pour cette experience?",
        answer:
          "Nous recommandons vetements confortables, maillot de bain, serviette, creme solaire et chaussures adaptees au terrain off-road et a l eau.",
      },
    ],
  },
};
...
const splitScapeOptionDescription = (description?: string | null) => {
  ...
  for (const sentence of sentences) {
    ...
    if (
      !schedule &&
      (lower.includes("opera de") ||
        lower.includes("disponible solo") ||
        lower.includes("recogida aproximada"))
    ) {
      schedule = sentence;
      continue;
    }
    if (
      !specialOps &&
      (lower.includes("turnos de buggy") ||
        lower.includes("sunshine cruise suele") ||
        lower.includes("itinerario suele ser mas relajado"))
    ) {
      specialOps = sentence;
      continue;
    }
    if (
      !bayahibe &&
      (lower.includes("bayahibe") || lower.includes("la romana"))
    ) {
      bayahibe = sentence;
      continue;
    }
    if (
      !returnWindow &&
      (lower.includes("regreso normalmente") ||
        lower.includes("regreso suele") ||
        lower.includes("llegada al hotel"))
    ) {
...
const buildCommercialIntentLinks = (
  locale: Locale,
  slug: string,
): IntentLink[] => {
...
const buildPracticalInfo = (locale: Locale, slug: string) => {
  ...
  const whatToBring = isBuggy
    ? localeLabel(
        ...
        [
          "Vetements qui peuvent se salir",
          "Serviette et vetements de rechange",
          "Creme solaire",
          "Chaussures fermees ou baskets",
        ].join(";"),
      )
    : localeLabel(
        locale,
  ...
  const restrictions = isBuggy
    ? localeLabel(
        ...
        [
          ...
          "Edad minima para conducir: 18",
          "No recomendado para lesiones de espalda severas",
        ].join(";"),
        [
          "Not suitable for pregnant travelers",
          "Minimum driving age: 18",
          "Not recommended for severe back injuries",
        ].join(";"),
        [
          "Non adapte aux femmes enceintes",
          "Age minimum pour conduire : 18 ans",
          "Non recommande pour lesions severes du dos",
        ].join(";"),
      )
    : localeLabel(
        locale,
        [
          "Sujeto a condiciones del clima",
          "Horarios pueden variar por operación local",
          "Seguir siempre indicaciones del guía",
        ].join(";"),
        [
          "Weather conditions may affect schedule",
          "Timings can vary due to local operations",
          "Always follow guide instructions",
        ].join(";"),
        [
          "Les conditions meteo peuvent affecter l horaire",
          "Les horaires peuvent varier selon l operation locale",
...
const resolveTourHeroImage = (tour: {
...
const DURATION_UNIT_LABELS: Record<
  Locale,
  Record<CanonicalDurationUnit, string>
> = {
  es: {
    minute: "minutos",
    hour: "horas",
...
const buildTourFaq = (
  ...
  return [
    ...
    },
    {
      ...
      answer: translate(locale, "tour.faq.answer.includes", {
        priceLabel,
...
export default async function TourDetailPage({
  ...
  if (
    agencyLinkFromQuery &&
    (!agencyProLink ||
      !agencyProLink.active ||
      agencyProLink.tourId !== tour.id)
  ) {
    notFound();
  }
  ...
  const agencyProfile =
    sessionUserRole === "AGENCY" && sessionUserId
      ...
      : null;
  const directAgencyMode =
    sessionUserRole === "AGENCY" &&
    resolvedSearchParams?.from === "agency" &&
    !agencyMode;
  ...
  const preferencePrice =
    allowPublicDiscounts && discountPercent > 0
      ? tour.price * (1 - discountPercent / 100)
      : tour.price;
  const effectiveTourPrice = agencyProLink
    ? agencyProLink.price
  ...
  const agencyDirectNetPrice =
    directAgencyMode && agencyDirectDiscountPercent > 0
      ? Math.round(
          effectiveTourPrice * (1 - agencyDirectDiscountPercent / 100) * 100,
        ) / 100
      : null;
  const displayTourPrice = agencyDirectNetPrice ?? effectiveTourPrice;
  const hasActiveDiscount =
    allowPublicDiscounts && effectiveTourPrice < tour.price;
  const discountTag =
    !allowPublicDiscounts || agencyProLink
      ? null
      : activeOffer
  ...
  const translationIncludes =
    (translation?.includesList as string[] | undefined) ?? [];
  const translationNotIncluded =
    (translation?.notIncludedList as string[] | undefined) ?? [];
  const translationHighlights =
    (translation?.highlights as string[] | undefined) ?? [];
  const translationItineraryStops =
    (translation?.itineraryStops as string[] | undefined) ?? [];
  ...
  const excludes = translationNotIncluded.length
    ...
    : notIncludedList.length
      ? notIncludedList
      : fallbackExcludes;
  const highlights = translationHighlights.length
    ? translationHighlights
    : rawHighlights;
  const seoOnlyHighlights = new Set([
    "hip hop",
    "hip hop party boat",
    "mar caribe",
  ]);
  const visibleHighlights = highlights.filter(
    (item) => !seoOnlyHighlights.has(item.trim().toLowerCase()),
  );
  ...
  const visibleHeroTitle = isDiscoveryMode
    ...
    : heroTitle;
  const localizedSubtitle = normalizeDisplayText(
    translation?.subtitle ?? tour.subtitle ?? "",
  );
  const localizedShortDescriptionSource =
    translation?.shortDescription ?? tour.shortDescription;
  const localizedDescriptionSource =
  ...
  const localizedShortDescription = localizedShortDescriptionSource
    ...
    : null;
  const localizedDescription = localizedDescriptionSource
    ? normalizeDisplayText(localizedDescriptionSource)
    : null;
  ...
  const shortTeaser =
    shortDescriptionText && shortDescriptionText.length > 220
      ...
      : (shortDescriptionText ??
        "Explora esta aventura guiada por expertos locales.");
  ...
  const relatedTourCards = relatedTours.map((item) => {
    const localizedRelatedTitle = ensureLeadingCapital(
      normalizeDisplayText(item.translations?.[0]?.title ?? item.title),
    );
    const relatedImage = resolveTourHeroImage(item);
    const relatedHref =
      locale === "es" ? `/tours/${item.slug}` : `/${locale}/tours/${item.slug}`;
    return {
      id: item.id,
      href: relatedHref,
      title: localizedRelatedTitle,
      price: `$${item.price.toFixed(0)} USD`,
      image: relatedImage.startsWith("http")
        ? relatedImage
        : `${PROACTIVITIS_URL}${relatedImage}`,
    };
  });
  const isSosuaPartyBoatTour =
    ...
    tour.slug ===
      "barco-privado-para-fiestas-con-todo-incluido-desde-puerto-plata-sosua";
  const commercialIntentLinks = agencyMode
    ? []
    : buildCommercialIntentLinks(locale, tour.slug);
  ...
  const currentScapeOptionId =
    selectedScapeOptionId ??
    tour.options?.find((option) => option.isDefault)?.id ??
    tour.options?.[0]?.id ??
    null;
  const regularOption =
    tour.options?.find((option) => /regular/i.test(option.name)) ??
    tour.options?.[0] ??
    null;
  const goldOption =
    tour.options?.find((option) => /gold/i.test(option.name)) ??
    tour.options?.[1] ??
    null;
  const drinkPackOption =
    tour.options?.find((option) => /drink pack/i.test(option.name)) ?? null;
  const scapeProducts = (tour.options ?? []).map((option) => {
    const optionKey = (option.type ?? option.name).toLowerCase();
    const structuredDescription = splitScapeOptionDescription(
      option.description,
    );
    const summary = option.description?.split(/(?<=[.!?])\s+/)[0]?.trim() || "";
    let focus = localeLabel(
      locale,
      "Opción disponible",
      "Available option",
      "Option disponible",
    ...
    if (optionKey.includes("full-admission")) {
      focus = localeLabel(
        locale,
        "Variedad y mejor relacion valor",
        "Best overall value and variety",
        "Meilleur rapport valeur-variete",
      );
      detail = localeLabel(
        locale,
        "Hoyo Azul, tirolesas, cuevas y aventura en un solo pase.",
        "Hoyo Azul, zip lines, caves and adventure in one pass.",
        "Hoyo Azul, tyroliennes, grottes et aventure en un seul pass.",
      );
    } else if (optionKey.includes("sunshine-cruise")) {
      focus = localeLabel(
        locale,
        "Selva + mar el mismo día",
        "Jungle + sea in one day",
        "Jungle + mer le meme jour",
      );
      detail = localeLabel(
        locale,
        "Parque completo, catamarán, snorkel y barra libre.",
        "Full park, catamaran, snorkel and open bar.",
        "Parc complet, catamaran, snorkel et open bar.",
      );
      ...
      detail = localeLabel(
        locale,
        "Parque completo con circuito 4x4 en buggy por la jungla.",
        "Full park plus a 4x4 buggy route through the jungle.",
        "Parc complet avec parcours buggy 4x4 dans la jungle.",
      );
      ...
      detail = localeLabel(
        locale,
        "Catamaran, Juanillo Beach Club, almuerzo y Blue Hole.",
        "Catamaran, Juanillo Beach Club, lunch and Blue Hole.",
        "Catamaran, Juanillo Beach Club, dejeuner et Blue Hole.",
      );
    }
        ...
        directAgencyMode && agencyDirectDiscountPercent > 0
          ? Math.round(
              (option.pricePerPerson ?? effectiveTourPrice) *
                (1 - agencyDirectDiscountPercent / 100) *
                100,
            ) / 100
          : (option.pricePerPerson ?? effectiveTourPrice),
      focus,
  ...
  const approvedReviews = await getApprovedTourReviewsForTour({
    id: tour.id,
    slug: tour.slug,
  });
  const reviewLocale =
  ...
  const translatedReviews = await Promise.all(
    approvedReviews.map(async (review) => {
      ...
      const sourceLocale =
        review.locale === "en" || review.locale === "fr"
          ? review.locale
          : "auto";
      ...
      return {
        ...
        title: translatedTitle
          ? normalizeDisplayText(translatedTitle)
          : translatedTitle,
        body: normalizeDisplayText(translatedBody),
      };
    }),
  );
  const reviewSummaryData = await getTourReviewSummaryForTour({
    id: tour.id,
    slug: tour.slug,
  });
  const detailReviewCount = reviewSummaryData.count;
  const ratingValue =
    reviewSummaryData.count > 0 ? reviewSummaryData.average : 0;
  ...
  const heroReviewsLabel = translate(locale, "tour.hero.reviewsCount", {
    count: detailReviewCount,
  });
  ...
  const languagesValue = languages.length
    ? languages.join(", ")
    : translate(locale, "tour.quickInfo.languages.pending");
  const languagesDetail = languages.length
    ? translate(locale, "tour.quickInfo.languages.detailAvailable", {
  ...
  const galleryImagesAbsolute = gallery
    .map((image) =>
      image.startsWith("http") ? image : `${PROACTIVITIS_URL}${image}`,
    )
    .filter((image) => image && image !== heroImageAbsolute);
  const schemaImages = [heroImageAbsolute, ...galleryImagesAbsolute].slice(
    0,
    10,
  );
  ...
  const schemaKeywords =
    TOUR_KEYWORDS_BY_SLUG[tour.slug]?.[locale] ??
    (PUNTA_CANA_TOP_TOURS.has(tour.slug)
      ...
      : NORTH_COAST_PARTY_BOAT_TOURS.has(tour.slug)
        ...
        : undefined);
  const schemaAlternateNames =
    TOUR_SCHEMA_ALTERNATE_NAMES_BY_SLUG[tour.slug]?.[locale];
  const schemaKeywordText =
    schemaKeywords || schemaAlternateNames
      ? [...(schemaKeywords ?? []), ...(schemaAlternateNames ?? [])].join(", ")
      : undefined;
  const schemaSku = (tour.productId || tour.slug).slice(0, 50);
      ...
      ? [
          {
            "@type": "PropertyValue",
            name: "Tour format",
            value: localeLabel(locale, "Privado", "Private", "Prive"),
          },
          {
            "@type": "PropertyValue",
            name: "Pickup",
            value: localeLabel(
              locale,
              "Disponible tras confirmar reserva",
          ...
          },
          {
            ...
            value: localeLabel(
              locale,
              "Cenote o rio natural",
              "Cenote or natural river",
              "Cenote ou riviere naturelle",
            ),
          },
          {
            "@type": "PropertyValue",
  ...
  const tourSchema = {
    ...
    ...(schemaAdditionalProperty
      ? { additionalProperty: schemaAdditionalProperty }
      : {}),
  ...
  const webPageSchema = {
    ...
    about: [{ "@id": `${tourUrl}#product` }, { "@id": `${tourUrl}#trip` }],
    ...(schemaAlternateNames ? { alternateName: schemaAlternateNames } : {}),
  ...
  const buildTourOptionHref = (optionId: string) => {
    ...
    if (resolvedSearchParams?.from)
      params.set("from", resolvedSearchParams.from);
  ...
  return (
    <div className="travel-surface min-h-screen overflow-x-clip pb-24 text-slate-950">
      ...
      <section className="mx-auto max-w-[1180px] px-4 pt-6 sm:pt-8">
        ...
        <div className="space-y-4">
          <div className="hidden flex-wrap items-center gap-2 text-xs font-semibold text-slate-600 lg:flex">
            ...
            {agencyMode ? (
              <span className="rounded-full bg-emerald-50 px-3 py-1 uppercase tracking-[0.18em] text-emerald-700">
                {agencyDisplayName ??
                  localeLabel(locale, "Agencia", "Agency", "Agence")}
              </span>
            ) : null}
            {isDiscoveryMode ? (
          ...
          <div className="grid gap-6 lg:grid-cols-[minmax(0,1fr)_360px]">
                ...
                <div className="space-y-4 rounded-[24px] border border-slate-100 bg-white p-6 shadow-md">
                  <div className="flex items-center justify-between">
                    ...
                    <p className="text-xs text-slate-500">
                      {translate(locale, "tour.section.coverage.note")}
                    </p>
                  </div>
                  ...
                  <div className="rounded-[28px] border border-slate-100 bg-white p-6 shadow-lg">
                        ...
                        <article className="rounded-[22px] border border-slate-200 bg-slate-50 p-5">
                          ...
                          <div className="mt-2 flex items-end justify-between gap-4">
                            ...
                            <p className="text-xl font-black text-slate-900">
                              $
                              {Number(
                                regularOption.pricePerPerson ?? tour.price,
                              ).toFixed(0)}
                            </p>
                          </div>
                          <ul className="mt-4 space-y-2 text-sm text-slate-700">
                            ...
                            <li>
                              ...
                              {localeLabel(
                                locale,
                                "Area general, normalmente de pie",
                                "General area, usually standing",
                                "Zone generale, souvent debout",
                              )}
                            </li>
                            <li>
                              •{" "}
                            ...
                            <li>
                              ...
                              {localeLabel(
                                locale,
                                "Ideal si priorizas precio",
                                "Best if price matters most",
                                "Ideal si le prix passe d abord",
                              )}
                            </li>
                          </ul>
                        </article>
                        ...
                        <article className="rounded-[22px] border border-amber-200 bg-amber-50 p-5">
                          ...
                          <div className="mt-2 flex items-end justify-between gap-4">
                            ...
                            <p className="text-xl font-black text-amber-800">
                              $
                              {Number(
                                goldOption.pricePerPerson ?? tour.price,
                              ).toFixed(0)}
                            </p>
                          </div>
                          <ul className="mt-4 space-y-2 text-sm text-slate-700">
                            ...
                            <li>
                              ...
                              {localeLabel(
                                locale,
                                "Asiento reservado y más espacio",
                                "Reserved seating and more space",
                                "Siege reserve et plus d espace",
                              )}
                            </li>
                            <li>
                              •{" "}
                              {localeLabel(
                                locale,
                                "Bar premium y mejor vista del show",
                                "Premium bar and better show view",
                                "Bar premium et meilleure vue sur le show",
                              )}
                            </li>
                            <li>
                              •{" "}
                              {localeLabel(
                                locale,
                                "Recomendado si no quieres pasar horas de pie",
                                "Recommended if you do not want to stand for hours",
                                "Recommande si vous ne voulez pas rester debout pendant des heures",
                              )}
                            </li>
                          </ul>
                        </article>
                    ...
                    <div className="mt-6 overflow-hidden rounded-[22px] border border-slate-200">
                      <div className="grid grid-cols-[1.3fr_1fr_1fr] bg-slate-100 text-xs font-semibold uppercase tracking-[0.2em] text-slate-500">
                        ...
                        <div className="px-4 py-3">
                          {regularOption?.name ?? "Regular"}
                        </div>
                        <div className="px-4 py-3">
                          {goldOption?.name ?? "Gold Member"}
                        </div>
                      </div>
                      {[
                        [
                        ...
                        [
                          localeLabel(
                            locale,
                            "Comodidad durante el show",
                            "Comfort during the show",
                            "Confort pendant le show",
                          ),
                        ...
                        [
                          ...
                          localeLabel(
                            locale,
                            "Quien quiere entrar al mejor precio",
                            "Travelers focused on the best price",
                            "Voyageurs axes sur le meilleur prix",
                          ),
                          localeLabel(
                            locale,
                            "Quien quiere espacio, asiento y experiencia VIP",
                            "Travelers wanting space, seating and VIP comfort",
                            "Voyageurs voulant espace, siege et confort VIP",
                          ),
                        ],
                      ].map((row) => (
                        <div
                          key={row[0]}
                          className="grid grid-cols-[1.3fr_1fr_1fr] border-t border-slate-200 text-sm text-slate-700"
                        >
                    ...
                    <div className="flex flex-wrap items-end justify-between gap-4">
                      <div>
                        <p className="text-xs uppercase tracking-[0.4em] text-slate-500">
                          {localeLabel(
                            locale,
                            "Comparativa Scape Park",
                            "Scape Park comparison",
                            "Comparatif Scape Park",
                          )}
                        </p>
                        <h2 className="mt-2 text-[20px] font-semibold text-slate-900">
                          {localeLabel(
                      ...
                      {hasVisualTimeline ? (
                        visualTimeline.map((stop, index) => (
                          <div
                            ...
                            className="flex gap-4 rounded-[16px] border border-[#F1F5F9] bg-white/70 px-4 py-3"
                          >
                            ...
                            <div className="text-sm leading-relaxed text-slate-700">
                              ...
                              <p>
                                {stop.description ??
                                  translate(
                                    locale,
                                    "tour.section.itinerary.detailPending",
                                  )}
                              </p>
                            </div>
                          </div>
                      ...
                      <div className="space-y-4">
                        <div className="flex items-center gap-3">
                          ...
                          <p className="text-xs uppercase tracking-[0.3em] text-slate-500">
                            {translate(
                              locale,
                              "tour.section.reviews.ratingOutOf",
                            )}
                          </p>
                        </div>
                        {detailReviewCount ? (
                      ...
                      <div className="space-y-4 max-h-[520px] overflow-y-auto pr-2">
                        {reviewHighlights.length ? (
                          reviewHighlights.map((review) => (
                            <div
                              key={review.id}
                              className="rounded-[16px] border border-[#F1F5F9] bg-white p-4 shadow"
                            >
                              <div className="flex items-center gap-3">
                  ...
                  <section id="faq" className="space-y-4">
                    ...
                    <div className="space-y-4 text-sm text-slate-700">
                      {faqList.map((item) => (
                        <article
                          key={item.question}
                          className="rounded-[16px] border border-[#F1F5F9] bg-white/60 p-4"
                        >
                          <p className="text-xs uppercase tracking-[0.3em] text-slate-500">
                            {item.question}
                          </p>
            ...
            <aside
              className="sticky top-20 hidden max-h-[calc(100dvh-6rem)] self-start overflow-y-auto overscroll-contain pb-4 pr-1 lg:block"
      ...
      {!agencyMode && relatedTourCards.length ? (
        <section
          id="related-tours"
          className="mx-auto mt-12 max-w-[1180px] px-4"
        >
                    ...
                    <div className="flex items-end justify-between gap-3 pt-2">
                      <p className="inline-flex items-center gap-1 text-sm font-black text-slate-950">
                        ...
                        <span className="text-xs font-semibold text-slate-500">
                          ({Math.max(detailReviewCount, 100)})
                        </span>
                      </p>
