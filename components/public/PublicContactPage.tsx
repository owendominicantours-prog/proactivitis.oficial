...
import { PROACTIVITIS_EMAIL, PROACTIVITIS_PHONE, PROACTIVITIS_WHATSAPP_LINK, PROACTIVITIS_WHATSAPP_NUMBER } from "@/lib/seo";
...
export default async function PublicContactPage({ locale }: PublicContactPageProps) {
  ...
  const contactEmails: { labelKey: TranslationKey; value: string }[] = [
    { labelKey: "contact.email.general", value: overrides.emails?.general ?? PROACTIVITIS_EMAIL },
    { labelKey: "contact.email.reservations", value: overrides.emails?.reservations ?? PROACTIVITIS_EMAIL },
    { labelKey: "contact.email.suppliers", value: overrides.emails?.suppliers ?? PROACTIVITIS_EMAIL }
  ];
