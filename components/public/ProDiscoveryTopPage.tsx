...
const COPY = {
  es: {
    ...
    introTours:
      "Seleccionamos y ordenamos las experiencias con mejor reputacion, mejor contexto de reserva y senales reales de confianza para ayudarte a elegir sin abrir veinte pestanas.",
    introTransfers:
      "Este ranking agrupa traslados con mejor reputacion, resenas aprobadas y rutas realmente buscadas para que compares antes de reservar.",
    whyTitle: "Como se ordena este ranking",
    whyOne: "Reputacion basada en resenas aprobadas",
