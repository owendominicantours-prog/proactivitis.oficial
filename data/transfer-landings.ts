...
export const transferLandings: TransferLandingData[] = [
  {
    ...
    seoTitle: "Private PUJ transfer to Hard Rock Hotel Punta Cana | Proactivitis",
    metaDescription: "Private transfer PUJ to Hard Rock Hotel Punta Cana with flight tracking, luggage help, and fixed price. Book door-to-lobby with 24/7 support.",
    keywords: [
